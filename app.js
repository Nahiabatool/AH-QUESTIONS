(function () {
  ...
  function getQuestionsForSet(setValue) {
    if (setValue === '4' && typeof QUIZ_QUESTIONS_SET4 !== 'undefined') return QUIZ_QUESTIONS_SET4;
    if (setValue === '3' && typeof QUIZ_QUESTIONS_SET3 !== 'undefined') return QUIZ_QUESTIONS_SET3;
    if (setValue === '2' && typeof QUIZ_QUESTIONS_SET2 !== 'undefined') return QUIZ_QUESTIONS_SET2;
  ...
  startBtn.addEventListener('click', function () {
    ...
    if (setValue === 'custom') {
      ...
      source = getQuestionsForSet(setValue);
