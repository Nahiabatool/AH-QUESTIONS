#!/usr/bin/env python3
"""Extract questions from RADIO NAVIGATION.pdf and output QUIZ_QUESTIONS_SET3."""
import re
import os
import json
...
PDF_PATH = r"c:\Users\Abbas Haider\AppData\Roaming\Cursor\User\workspaceStorage\59c9cd72e8be94a90f18f038d506a7a1\pdfs\e8cf0f08-47dc-4d91-bb16-ff82e45e6ad4\RADIO NAVIGATION.pdf"
...
def main():
    ...
    skip = {"Question", "Choices", "Answers", "Correct", "Total", "Questions", "FLIGHT PLANNING", "RADIO NAVIGATION"}
    ...
    start_pattern = re.compile(
        r"^(\(Refer|Given|How|What|Which|For\s|An\s|You\s|When|At\s|The\s|A\s|In\s|From\s|During|If\s|Your|Ground|Diffraction|To establish|With reference|An aircraft|A half wave|A VDF|In radio|In which)",
        re.I
    )
    q_texts = []
    current = []
    ...
    js_path = os.path.join(out_dir, "radio_navigation_set3.js")
    with open(js_path, "w", encoding="utf-8") as f:
        f.write("// RADIO NAVIGATION.pdf - Set 3 (" + str(len(out)) + " questions)\n")
        f.write("const QUIZ_QUESTIONS_SET3 = ")
